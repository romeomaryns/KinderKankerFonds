package eu.maryns.romeo.kinderkankerfonds;
...
public class KinderkankerfondsTestContainer extends TestContainer {

    public KinderkankerfondsTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "eu/maryns/romeo/kinderkankerfonds/app.properties",
    ...
    public static class Common extends KinderkankerfondsTestContainer {

        public static final KinderkankerfondsTestContainer.Common INSTANCE = new KinderkankerfondsTestContainer.Common();
